...
class MemberCollectionTest {
    ...
    @Test
    void add_1() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        memberCollection.add(new Member("test", "test", "test", 0000));
        assertEquals(MemberCollection.memberCount, 1);
    }

    @Test
    void addMax() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
    ...
    @Test
    void addExceedMax() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        for (int i = 0; i < MAX_MEMBERS; i++) {
            memberCollection.add(new Member("test" + i, "test", "test", 0000));
        }
    ...
    @Test
    void addAlreadyExists() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        memberCollection.add(new Member("test", "test", "test", 0000));
    ...
    @Test
    void addExceedOverAlreadyExists() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        for (int i = 0; i < MAX_MEMBERS; i++) {
            memberCollection.add(new Member("test" + i, "test", "test", 0000));
        }
        assertThrows(MembersOutOfBoundsException.class, () ->
    ...
    @Test
    void remove_1() throws MemberDoesNotExistException, MembersOutOfBoundsException, MemberAlreadyExistsException {
        memberCollection.add(new Member("test", "test", "test", 0000));
    ...
    @Test
    void removeLast() throws MemberDoesNotExistException, MembersOutOfBoundsException, MemberAlreadyExistsException {
        for (int i = 0; i < MAX_MEMBERS; i++) {
            memberCollection.add(new Member("test" + i, "test", "test", 0000));
        }
    ...
    @Test
    void removeCheckLastNull() throws MemberDoesNotExistException, MembersOutOfBoundsException, MemberAlreadyExistsException {
        for (int i = 0; i < MAX_MEMBERS; i++) {
            memberCollection.add(new Member("test" + i, "test", "test", 0000));
        }
        memberCollection.remove("test" + (MAX_MEMBERS - 1));
    ...
    @Test
    void removeExceptionFromFull() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        for (int i = 0; i < MAX_MEMBERS; i++) {
            memberCollection.add(new Member("test" + i, "test", "test", 0000));
        }
        assertThrows(MemberDoesNotExistException.class, () ->
    ...
    @Test
    void search_1() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        memberCollection.add(new Member("test", "test", "test", 0000));
        assertEquals(memberCollection.search("test"), 0);
    }

    @Test
    void searchLast() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
    ...
    @Test
    void searchDoesntExist2() throws MembersOutOfBoundsException, MemberAlreadyExistsException {
        memberCollection.add(new Member("test", "test", "test", 0000));
        assertEquals(memberCollection.search("aaa"), -1);
    }
}